...
router.post('/request-password-reset', validation_1.validateRequestPasswordReset, UserController_1.userController.requestPasswordReset.bind(UserController_1.userController));
router.post('/reset-password-with-code', validation_1.validateResetPasswordWithCode, UserController_1.userController.resetPasswordWithCode.bind(UserController_1.userController));
